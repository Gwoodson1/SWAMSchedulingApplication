...
from .controllers.InstructorController import create_instructor, read_instructor, update_instructor, delete_instructor, get_all_instructors, update_instructor_by_username
...
from .controllers.LessonController import create_lesson, read_lesson, get_all_lessons, update_lesson, delete_lesson
from .controllers.SwimmerController import create_swimmer, read_swimmer, get_all_swimmers, update_swimmer, delete_swimmer
...
def get_instructor(instructor_id):
    try:
        ...
        print(f"Error in get_instructor: {str(e)}")
        return jsonify(error=str(e)), 500
...
def get_instructors():
    try:
        ...
        print(f"Error in get_all_instructors: {str(e)}")
        return jsonify(error=str(e)), 500
...
def remove_instructor(instructor_id):
    try:
        ...
        return jsonify(deleted_instructor), 204
    except Exception as e:
...
def modify_instructor_by_username(username):
    try:
        ...
        print(f"Error in modify_instructor_by_username: {str(e)}")
        return jsonify(error=str(e)), 500
...
def get_instructors_by_username(username):
    try:
        ...
        print(f"Error in get_instructor_by_username: {str(e)}")
        return jsonify(error=str(e)), 500
...
def remove_parent(parent_id):
    try:
        ...
        return jsonify(deleted_parent), 204
    except Exception as e:
...
def add_swimmer():
    try:
        ...
        print(f"Error in add_swimmer: {str(e)}")
        return jsonify(error=str(e)), 500
...
def get_swimmer(swimmer_id):
    try:
        ...
        print(f"Error in get_swimmer: {str(e)}")
        return jsonify(error=str(e)), 500
...
def get_swimmers():
    try:
        ...
        print(f"Error in get_all_swimmers: {str(e)}")
        return jsonify(error=str(e)), 500
...
def modify_swimmer(swimmer_id):
    try:
        ...
        print(f"Error in modify_swimmer: {str(e)}")
        return jsonify(error=str(e)), 500
...
def remove_swimmer(swimmer_id):
    try:
        ...
        return jsonify(deleted_swimmer), 204
    except Exception as e:
        print(f"Error in remove_swimmer: {str(e)}")
        return jsonify(error=str(e)), 500
...
def get_lessons():
    try:
        ...
        print(f"Error in get_all_lessons: {str(e)}")
        return jsonify(error=str(e)), 500
...
def modify_lesson(lesson_id):
    try:
        ...
        print(f"Error in modify_lesson: {str(e)}")
        return jsonify(error=str(e)), 500
...
def remove_lesson(lesson_id):
    try:
        ...
        return jsonify(deleted_lesson), 204
    except Exception as e:
        print(f"Error in remove_lesson: {str(e)}")
        return jsonify(error=str(e)), 500
